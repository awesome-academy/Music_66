...
object FragmentUtils {
    fun addFragment(fragmentManager: FragmentManager, fragment: BaseFragment,
                    screenAnimation: ScreenAnimation, containerViewId: Int,
                    isAddFragment: Boolean, isAddBackStack: Boolean) {
        ...
        if (isAddBackStack) transaction.addToBackStack(fragment::class.java.name)
        transaction.commit()
    }
